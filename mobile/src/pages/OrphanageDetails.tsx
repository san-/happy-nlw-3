...
interface OrphanageDetailsParamns {
  id: number;
}
...
export default function OrphanageDetails() {
  ...
  const params = route.params as OrphanageDetailsParamns;
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>{orphanage.contact}</Text>

        {orphanage.is_whatsapp && (
          //TODO: link para whatsapp
          <RectButton style={styles.contactButton} onPress={() => { }}>
            <FontAwesome name="whatsapp" size={24} color="#FFF" />
            <Text style={styles.contactButtonText}>Entrar em contato via Whatsapp</Text>
          </RectButton>
        )}
